...
window.UI = (function () {
  ...
  const P = {
    ...
    /* --- v2.4.1.smbowner additions --- */
    store: '<path d="M4.5 9.5 6 4.5h12l1.5 5a2.5 2.5 0 0 1-5 .2 2.5 2.5 0 0 1-5 0 2.5 2.5 0 0 1-5-.2z"/><path d="M5.5 11v8.5h13V11"/><path d="M10 19.5v-5h4v5"/>',
    wallet: '<rect x="3.5" y="6" width="17" height="13" rx="2.5"/><path d="M3.5 9.5h17M16 13h2"/>',
    coins: '<ellipse cx="9" cy="7" rx="5" ry="2.6"/><path d="M4 7v4c0 1.4 2.2 2.6 5 2.6s5-1.2 5-2.6V7"/><path d="M10 13.6V17c0 1.4 2.2 2.6 5 2.6s5-1.2 5-2.6v-4c0-1.4-2.2-2.6-5-2.6"/>',
    scale: '<path d="M12 4.5v15M7 19.5h10M5 7.5h14"/><path d="M8.5 7 5.5 13.5a3 3 0 0 0 6 0zM15.5 7l-3 6.5a3 3 0 0 0 6 0z"/>',
    percent: '<circle cx="7.5" cy="7.5" r="2.5"/><circle cx="16.5" cy="16.5" r="2.5"/><path d="m6 18 12-12"/>',
    ...
    server: '<rect x="4" y="4.5" width="16" height="6" rx="2"/><rect x="4" y="13.5" width="16" height="6" rx="2"/><path d="M7.5 7.5h.01M7.5 16.5h.01"/>',
    ban: '<circle cx="12" cy="12" r="8.5"/><path d="m6.2 6.2 11.6 11.6"/>',
    unlock: '<rect x="5.5" y="10.5" width="13" height="9.5" rx="2.5"/><path d="M8.5 10.5V8a3.5 3.5 0 0 1 6.8-1.2"/>',
    idcard: '<rect x="3.5" y="5.5" width="17" height="13" rx="2.5"/><circle cx="8.5" cy="11" r="2.1"/><path d="M5.5 16c.5-1.6 1.7-2.4 3-2.4s2.5.8 3 2.4M14 9.5h4M14 12.5h4M14 15.5h2.5"/>',
    camera: '<path d="M4.5 8.5h3l1.3-2h6.4l1.3 2h3v9.5a1.5 1.5 0 0 1-1.5 1.5H6a1.5 1.5 0 0 1-1.5-1.5z"/><circle cx="12" cy="13" r="3.1"/>',
    briefcase: '<rect x="3.5" y="8" width="17" height="11" rx="2.2"/><path d="M9 8V6.5A1.5 1.5 0 0 1 10.5 5h3A1.5 1.5 0 0 1 15 6.5V8M3.5 13h17"/>',
    filter: '<path d="M4.5 6h15l-5.6 6.6v4.6l-3.8 2v-6.6z"/>',
    dots: '<circle cx="6" cy="12" r="1.4"/><circle cx="12" cy="12" r="1.4"/><circle cx="18" cy="12" r="1.4"/>',
    upload: '<path d="M12 15.5v-10M7.5 9 12 4.5 16.5 9"/><path d="M5 19.5h14"/>',
    chat: '<path d="M5 5.5h14a1.5 1.5 0 0 1 1.5 1.5v8a1.5 1.5 0 0 1-1.5 1.5H9l-4 3.2V16H5A1.5 1.5 0 0 1 3.5 14.5V7A1.5 1.5 0 0 1 5 5.5z"/><path d="M8 10h8M8 12.5h5"/>',
    cloud: '<path d="M7.5 18.5a4 4 0 0 1-.5-7.97 5 5 0 0 1 9.7-1.2A3.8 3.8 0 0 1 17 18.5z"/>',
    userCheck: '<circle cx="9.5" cy="8" r="3.4"/><path d="M3.8 19c1.1-3 3.4-4.5 5.7-4.5 1 0 2 .3 2.9.8M15 16l1.8 1.8 3.2-3.6"/>',
    userPlus: '<circle cx="9.5" cy="8" r="3.4"/><path d="M3.8 19c1.2-3.1 3.5-4.6 5.7-4.6 1.1 0 2.1.3 3 .9M17 13.5v5M14.5 16h5"/>',
    tag: '<path d="M4.5 11.5V5.5a1 1 0 0 1 1-1h6l8 8a1.4 1.4 0 0 1 0 2l-6 6a1.4 1.4 0 0 1-2 0z"/><circle cx="8.5" cy="8.5" r="1.3"/>',
    gauge: '<path d="M4 17a8 8 0 1 1 16 0"/><path d="m12 13 4-3.5"/><circle cx="12" cy="17" r="1.3"/>',
    swap: '<path d="M7 7h11l-3-3M17 17H6l3 3"/>',
    power: '<path d="M12 4v8M7.5 7a7 7 0 1 0 9 0"/>',
    qr: '<rect x="4" y="4" width="6" height="6" rx="1"/><rect x="14" y="4" width="6" height="6" rx="1"/><rect x="4" y="14" width="6" height="6" rx="1"/><path d="M14 14h2v2M20 14v.01M14 20h.01M18 18h2v2"/>',
    book: '<path d="M5 5.5A1.5 1.5 0 0 1 6.5 4H19v16H6.5A1.5 1.5 0 0 0 5 21.5z"/><path d="M5 18.5A1.5 1.5 0 0 1 6.5 17H19"/>',
    sliders: '<path d="M5 8h7M16 8h3M5 16h3M12 16h7"/><circle cx="14" cy="8" r="2"/><circle cx="10" cy="16" r="2"/>',
    calCheck: '<rect x="4" y="5.5" width="16" height="14" rx="3"/><path d="M4 10h16M8.5 3.8v3.4M15.5 3.8v3.4M9 14.5l2 2 4-4"/>'
  };
  ...
  function sparkline(values, opts = {}) {
    ...
    return `<svg class="chart" viewBox="0 0 ${w} ${h}" preserveAspectRatio="none" aria-hidden="true">
      ...
      <circle cx="${last[0].toFixed(1)}" cy="${last[1].toFixed(1)}" r="3" fill="var(--acc-d)"/>
    </svg>`;
  }
  ...
  function bars(data, opts = {}) {
    ...
    return `<svg class="chart" viewBox="0 0 ${w} ${h}" aria-hidden="true">
      ...
      return `<rect x="${x.toFixed(1)}" y="${y.toFixed(1)}" width="${bw.toFixed(1)}" height="${bh.toFixed(1)}" rx="5" fill="${fill}" opacity="${d.tone === "soft" ? ".9" : ".88"}"/>
  ...
  function lines2(a, b, labels, opts = {}) {
    ...
    return `<svg class="chart" viewBox="0 0 ${w} ${h}" aria-hidden="true">
      ...
      ${[max, (max + min) / 2, min].map((v, i) => `<text x="${padL - 6}" y="${gridY[i] + 3}" text-anchor="end" font-size="8.5" fill="var(--muted-2)" font-weight="600">${fmt(Math.round(v * 10) / 10)}</text>`).join("")}
  ...
  /* ---------- v2.4.1.smbowner components ---------- */
  function meter(pct, tone) {
    const p = Math.max(0, Math.min(100, pct));
    return `<div class="meter"><i class="${tone || ""}" style="width:${p}%"></i></div>`;
  }
  function lvlpill(level, active) {
    const m = { L0: ["l0", "L0 Cash"], L1: ["l1", "L1 Basic"], L2: ["l2", "L2 Compliant"], L3: ["l3", "L3 Full"] };
    const [c, l] = m[level] || ["l0", level];
    return `<span class="lvlpill ${c} ${active ? "on" : ""}">${esc(l)}</span>`;
  }
  function tile(o) {
    // compact dashboard cockpit tile
    return `<div class="tile ${o.accent ? "accent" : ""}" ${o.go ? `data-go="${o.go}" role="button" tabindex="0"` : ""}>
      <span class="tl-label">${o.icon ? icon(o.icon) : ""}${esc(o.label)}</span>
      <span class="tl-value num">${o.value}</span>
      ${o.sub ? `<span class="tl-sub">${o.sub}</span>` : ""}
    </div>`;
  }
  function flowRail(items) {
    return `<div class="flowrail">${items.map(s => `<div class="fr-st"><div class="fr-h">${esc(s.t)}</div><div class="fr-p">${esc(s.s || "")}</div></div>`).join("")}</div>`;
  }
  function segMeter(label, used, total, opts = {}) {
    const pct = total ? Math.round(used / total * 100) : 0;
    const tone = opts.tone || (pct >= 90 ? "bad" : pct >= 75 ? "warn" : "ok");
    return `<div class="segmeter">
      <div class="sm-top"><span>${esc(label)}</span><span class="mono">${used}/${total}${opts.unit ? " " + opts.unit : ""}</span></div>
      ${meter(pct, tone)}
    </div>`;
  }

  return { icon, esc, initials, kip, kpi, card, badge, idtag, rowitem, rowlist, table, steps, empty, avatar, sparkline, bars, lines2, donut, heatcal, legend, lockMsg, lockTag, lockBtn, lockChoice, meter, lvlpill, tile, flowRail, segMeter };
})();
